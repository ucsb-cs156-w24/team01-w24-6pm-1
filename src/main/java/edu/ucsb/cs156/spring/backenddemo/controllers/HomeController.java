...
public class HomeController {
    ...
    public static String getHomePageObjectJSON(String baseUrl) throws JsonProcessingException {
        ...
        resultMap.put("greeting", "Greetings from Drifting Raptors!");

        List<String> team = new ArrayList<String>();
        team.add("Sanil Katula");
        team.add("Kushagra Kanaujia");
        team.add("Shashank Bhagwani");
        team.add("Victor Nardi");
        team.add("Jenil Prajapati");
        team.add("Philly Lim");
